...
main(void)
{
    ...
    if (eingabe == 0) {
        ...
        for (int round = 0; round < 31; round++) {
            ...
            temp_0 = pBox8_0[state & 0xFF]; // store new value into temp
                                            // variable

            temp_1 = (temp_1 >> 8); // shift 1 byte
            temp_1 =
              pBox8_1[temp_1 & 0xFF]; // store new value into temp variable

            temp_2 = (temp_2 >> 16); // shift 2 byte
            temp_2 =
              pBox8_2[temp_2 & 0xFF]; // store new value into temp variable

            temp_3 = (temp_3 >> 24); // shift 3 byte
            temp_3 =
              pBox8_3[temp_3 & 0xFF]; // store new value into temp variable

            temp_4 = (temp_4 >> 32); // shift 4 byte
            temp_4 =
              pBox8_4[temp_4 & 0xFF]; // store new value into temp variable

            temp_5 = (temp_5 >> 40); // shift 5 byte
            temp_5 =
              pBox8_5[temp_5 & 0xFF]; // store new value into temp variable

            temp_6 = (temp_6 >> 48); // shift 6 byte
            temp_6 =
              pBox8_6[temp_6 & 0xFF]; // store new value into temp variable

            temp_7 = (temp_7 >> 56); // shift 7 byte
            temp_7 =
              pBox8_7[temp_7 & 0xFF]; // store new value into temp variable

            state = temp_0 | temp_1 | temp_2 | temp_3 | temp_4 | temp_5 |
                    temp_6 | temp_7; // XOR of the results
            //	****************** End pLayer **************************
        }
        //	****************** addRoundkey *************************
        state ^= subkey[31];
    ...
    //	****************** Decryption **************************
        ...
        for (int round = 1; round < 32; round++) {
            ...
            if ((round) % 2 == 1 &&
                round != 31) // Key rearrangement for reduced P-Layer method
            {
                ...
                keyhigh = keysched_0 | keysched_1 | keysched_2 | keysched_3 |
                          keysched_4 | keysched_5 | keysched_6 | keysched_7 |
                          keysched_8 | keysched_9 | keysched_a | keysched_b |
                          keysched_c | keysched_d | keysched_e | keysched_f;
            }
        ...
        temp_1 = (temp_1 >> 8);             // shift 1 byte
        temp_1 = invpBox8_1[temp_1 & 0xFF]; // store new value into temp
                                            // variable

        temp_2 = (temp_2 >> 16);            // shift 2 byte
        temp_2 = invpBox8_2[temp_2 & 0xFF]; // store new value into temp
                                            // variable

        temp_3 = (temp_3 >> 24);            // shift 3 byte
        temp_3 = invpBox8_3[temp_3 & 0xFF]; // store new value into temp
                                            // variable

        temp_4 = (temp_4 >> 32);            // shift 4 byte
        temp_4 = invpBox8_4[temp_4 & 0xFF]; // store new value into temp
                                            // variable

        temp_5 = (temp_5 >> 40);            // shift 5 byte
        temp_5 = invpBox8_5[temp_5 & 0xFF]; // store new value into temp
                                            // variable

        temp_6 = (temp_6 >> 48);            // shift 6 byte
        temp_6 = invpBox8_6[temp_6 & 0xFF]; // store new value into temp
                                            // variable

        temp_7 = (temp_7 >> 56);            // shift 7 byte
        temp_7 = invpBox8_7[temp_7 & 0xFF]; // store new value into temp
                                            // variable

        state = temp_0 ^ temp_1 ^ temp_2 ^ temp_3 ^ temp_4 ^ temp_5 ^ temp_6 ^
                temp_7; // XOR of the results
        ...
        temp_0 = unsigned __int64(
          invsBox16[state & 0xFFFF]); // put new value to lowest 2 byte

        sBoxState_1 = sBoxState_1 >> 16; // shift 2 byte
        temp_1      = unsigned __int64(invsBox16[sBoxState_1 & 0xFFFF])
                 << 16; // put new value to lowest 2 byte

        sBoxState_2 = sBoxState_2 >> 32; // shift 4 byte
        temp_2      = unsigned __int64(invsBox16[sBoxState_2 & 0xFFFF])
                 << 32; // put new value to lowest 2 byte

        sBoxState_3 = sBoxState_3 >> 48; // shift 6 byte
        temp_3      = unsigned __int64(invsBox16[sBoxState_3 & 0xFFFF])
                 << 48; // put new value to lowest 2 byte
        ...
        for (int round = 15; round > 0; round--) {
            ...
            temp_7 = state;
            temp_0 =
              invpBox8_0_reduced[state &
                                 0xFF]; // store new value into temp variable

            temp_1 = (temp_1 >> 8); // shift 1 byte
            temp_1 =
              invpBox8_1_reduced[temp_1 &
                                 0xFF]; // store new value into temp variable

            temp_2 = (temp_2 >> 16); // shift 2 byte
            temp_2 =
              invpBox8_2_reduced[temp_2 &
                                 0xFF]; // store new value into temp variable

            temp_3 = (temp_3 >> 24); // shift 3 byte
            temp_3 =
              invpBox8_3_reduced[temp_3 &
                                 0xFF]; // store new value into temp variable

            temp_4 = (temp_4 >> 32); // shift 4 byte
            temp_4 =
              invpBox8_4_reduced[temp_4 &
                                 0xFF]; // store new value into temp variable

            temp_5 = (temp_5 >> 40); // shift 5 byte
            temp_5 =
              invpBox8_5_reduced[temp_5 &
                                 0xFF]; // store new value into temp variable

            temp_6 = (temp_6 >> 48); // shift 6 byte
            temp_6 =
              invpBox8_6_reduced[temp_6 &
                                 0xFF]; // store new value into temp variable

            temp_7 = (temp_7 >> 56); // shift 7 byte
            temp_7 =
              invpBox8_7_reduced[temp_7 &
                                 0xFF]; // store new value into temp variable
            ...
            temp_0 = unsigned __int64(
              invsBox16_reduced[state &
                                0xFFFF]); // put new value to lowest 2 byte

            sBoxState_1 = sBoxState_1 >> 16; // shift 2 byte
            temp_1 = unsigned __int64(invsBox16_reduced[sBoxState_1 & 0xFFFF])
                     << 16; // put new value to lowest 2 byte

            sBoxState_2 = sBoxState_2 >> 32; // shift 4 byte
            temp_2 = unsigned __int64(invsBox16_reduced[sBoxState_2 & 0xFFFF])
                     << 32; // put new value to lowest 2 byte

            sBoxState_3 = sBoxState_3 >> 48; // shift 6 byte
            temp_3 = unsigned __int64(invsBox16_reduced[sBoxState_3 & 0xFFFF])
                     << 48; // put new value to lowest 2 byte
