...
main(void)
{
    ...
    for (int round = 15; round > 0; round--) {
        ...
        temp_6 = state;
        temp_7 = state;
        temp_0 = invpBox8_0_reduced[state &
                                    0xFF]; // store new value into temp variable

        temp_1 = (temp_1 >> 8); // shift 1 byte
        temp_1 = invpBox8_1_reduced[temp_1 &
                                    0xFF]; // store new value into temp variable

        temp_2 = (temp_2 >> 16); // shift 2 byte
        temp_2 = invpBox8_2_reduced[temp_2 &
                                    0xFF]; // store new value into temp variable

        temp_3 = (temp_3 >> 24); // shift 3 byte
        temp_3 = invpBox8_3_reduced[temp_3 &
                                    0xFF]; // store new value into temp variable

        temp_4 = (temp_4 >> 32); // shift 4 byte
        temp_4 = invpBox8_4_reduced[temp_4 &
                                    0xFF]; // store new value into temp variable

        temp_5 = (temp_5 >> 40); // shift 5 byte
        temp_5 = invpBox8_5_reduced[temp_5 &
                                    0xFF]; // store new value into temp variable

        temp_6 = (temp_6 >> 48); // shift 6 byte
        temp_6 = invpBox8_6_reduced[temp_6 &
                                    0xFF]; // store new value into temp variable

        temp_7 = (temp_7 >> 56); // shift 7 byte
        temp_7 = invpBox8_7_reduced[temp_7 &
                                    0xFF]; // store new value into temp variable
        ...
        temp_0 = unsigned __int64(
          invsBox16_reduced[state & 0xFFFF]); // put new value to lowest 2 byte
